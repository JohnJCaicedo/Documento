	...
	\section{Red Neuronal Artificial}
		...
		\subsection{Arquitectura del modelo}
			...
			\begin{enumerate}
				...
				\item\bfseries{CONSTRUCCIÓN DEL MODELO}
				\\
				...
				\item\bfseries{FORMACIÓN DEL MODELO}
				\\
				...
				\item \bfseries{PRUEBA DEL MODELO}
				\\
