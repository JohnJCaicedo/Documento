...
\chapter{Algoritmo de clasificación}
	...
	\section{Red neuronal artificial}
		...
		\subsection{Data Augmentation}
			...
			El Data Augmentation cuenta con diferentes tipos de filtros que pueden ser aplicados a los datos que posee el conjunto de entrenamiento, como los mostrados en la siguiente tabla.
		...
		\subsection{Datasets y DataLoaders}
			...
			Según como se explico en el apartado anterior el tipo de dataset implementando para este pryecto es del tipo ITERABLE-STYLE DATASETS 
