...
\newpage
	\section{Descripción de la maquina}
		\begin{figure}[ht]
		\centering
		\includegraphics[scale=0.9]{Figs/65.png}
	...
	\section{Estructura}
		...
		\subsection{Bombillos}
			La estructura cuenta con dos agujeros donde se ubican dos bombillos de luz blanca de 6500 Kelvin de temperatura de color para mantener la iluminación fija de todas las fotos al igual que se tomaron durante la construcción del Dataset.
		\subsection{Sensor Optico}
