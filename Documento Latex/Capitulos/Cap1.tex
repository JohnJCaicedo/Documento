...
Se presenta la distribución del dataset segun sus categorias.  

\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{Figs/1.png}
	\caption{Distribución de la categoría Tipo}
	\label{fig:Ctipo}
\end{figure}

La distribucón para la categoría \textit{Tipo}, cuenta con 342 imagenes de tuberculos \textit{R12} frente a 250 imagenes del tipo \textit{Pastusa}.

\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{Figs/2.png}
	\caption{Distribución de la categoría daño}
	\label{fig:Cdaño}
\end{figure}

La distribucón para la categoría \textit{Daño}, cuenta con 346 imagenes de tuberculos \textit{Defectuosos} y 246 imagenes de tuberculos \textit{Buenos}
